<?php
/**
 * Plugin Name: Angular Stage Demo
 * Plugin URI: https://github.com/devbaze/angular-stage
...
class ngApp
{
    ...
    public function __construct()
    {
        ...
        $this->base_href = '/' . basename(dirname(__FILE__)) . '/'; // Matches /angular-stage/
        ...
        add_shortcode('shortcode', array( $this, 'weather_api' ));
    }
    ...
    public function intercept_wp_router($continue, WP $wp, $extra_query_vars)
    {
        ...
        $page_title = 'WordPress Angular.js Stage Plugin Demo App | https://github.com/devbaze';
